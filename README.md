...
- 🏠 **[Real Estate Platform](https://nova-delta-flax.vercel.app/)** ([repo](https://github.com/next-winter-1404/nova)) — A real estate listing platform built with Next.js & TypeScript
- 📚 **[Programming Courses Platform](https://github.com/react-summer-1404/Nova)** — An online course-selling platform built with React
